            ...
            <StyledWrapper>
                <form onSubmit={handleSubmit(handleRegister)} className="form">
                    ...
                    <div className="inputForm">
                        <FaUser></FaUser>
                        <input type="text" {...register('name')} className="input" placeholder="Enter your full name" />
                    </div>
                    <div className="flex-column">
                        <label>Profile Photo </label></div>
                    <div className="inputForm">
                        <LuCircleUser size={20} />
                        <input type="text" {...register('photoUrl')} className="input" placeholder="Enter your photo url" />
                    </div>
                    <div className="flex-column">
